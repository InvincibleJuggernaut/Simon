<p align = center>
  <img src = https://see.fontimg.com/api/rf5/0vWd/NjgzMjI2ZTc4NGNhNDkxODg4YmZkMmQwNDYzMzhmOWQudHRm/U0lNT04/dreamland.png?r=fs&h=134&w=1000&fg=AF1313&bg=FFFFFF&tb=1&s=134>
...
<ul>
  ...
  <li>Speaker/DAC (for audio tones)</li>
  <li>Wires & resistors</li>
</ul>
...
- **Configuration Files**: `.Uv2` (project), `.Opt` (options), `.sct` (scatter/linker)

The assembly startup (`LPC2300.s`) is linked first to set up the CPU; then C code initializes peripherals and runs the game.
